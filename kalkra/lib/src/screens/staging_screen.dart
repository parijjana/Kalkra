  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<MatchStatus>(matchStatusProvider, (p, n) {
      if (n == MatchStatus.playing) {
        ...
        if (ref.read(isHostOnlyProvider)) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (c) => const SpectatorScreen()),
          );
        } else if (match?.gameMode == GameMode.tripleThreat || match?.gameMode == GameMode.doubleDanger) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (c) => const MultiTargetScreen()),
          );
        } else {
          Navigator.of(context).pushReplacement(
