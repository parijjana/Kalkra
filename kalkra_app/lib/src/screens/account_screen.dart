...
class _AccountScreenState extends ConsumerState<AccountScreen> {
  ...
  Widget _buildAudioControls(CareerManager career) {
      ...
      child: Column(
        children: [
          _buildAudioTile(
            ...
            title: 'SOUND EFFECTS',
            subtitle: 'UI feedback and game alerts',
            value: career.soundEnabled,
            onChanged: (v) => ref.read(careerProvider.notifier).setSoundEnabled(v),
          ...
          _buildAudioTile(
            ...
            subtitle: 'Immersive atmospheric audio',
            value: career.musicEnabled,
            onChanged: (v) => ref.read(careerProvider.notifier).setMusicEnabled(v),
