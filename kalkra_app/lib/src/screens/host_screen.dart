...
class _HostScreenState extends ConsumerState<HostScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final connectionString =
        'ws://$_ipAddress:$_port${secret != null ? "?secret=$secret" : ""}';

    // Difficulty label logic
    String diffLabel = _isProgressive
        ? 'PROGRESSIVE'
      ...
      appBar: AppBar(
        title: Row(
          ...
          children: [
            ...
            const Flexible(
              child: Text('HOST SETUP', overflow: TextOverflow.ellipsis),
            ),
          ],
        ),
                  ...
                  children: [
                    ...
                    _SettingRow(
                      ...
                      onDecrement: () => setState(
                        () => _totalRounds = (_totalRounds - 1).clamp(1, 20),
                      ),
                      ...
                      onDecrement: () {
                        setState(() {
                          if (_isProgressive) {
                            ...
                            _difficulty =
                                Difficulty.values[_difficulty.index - 1];
                          } else {
                            _isProgressive = true;
                          }
                        });
                ...
                child: ElevatedButton(
                  onPressed: _isHosting
                      ? () async {
                          ...
                          ref
                              .read(isHostOnlyProvider.notifier)
                              .setState(_isSpectator);
