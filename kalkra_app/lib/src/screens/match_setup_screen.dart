  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        appBar: isDesktop
            ? const TopNavBar(activeId: 'MainScreen')
            : _buildMobileAppBar(),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'SYSTEM CALIBRATION AND VECTOR SELECTION',
                  style: TextStyle(
                    letterSpacing: 4,
                          ...
                          children: [
                            ...
                            Expanded(
                              child: SingleChildScrollView(
                                child: _buildModeSelector(isDesktop: true),
                              ),
                            ),
                          ],
                        ),
  ...
  Widget _buildModeSelector({required bool isDesktop}) {
    ...
    final modes = [
      ...
      (
        ...
        label: 'PROGRESSIVE',
        desc: 'Tiered challenges.',
        icon: Icons.trending_up_rounded,
      ),
      (
        mode: GameMode.tunnelVision,
        label: 'TUNNEL',
        desc: 'Persistent target.',
        icon: Icons.filter_center_focus_rounded,
      ),
      (
        mode: GameMode.powersOf2,
        label: "2'S POWERS",
        desc: 'Powers of 2 only.',
        icon: Icons.filter_2_rounded,
      ),
      (
        mode: GameMode.powersOf3,
        label: "3'S POWERS",
        desc: 'Powers of 3 only.',
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (context) => CalibrationScreen(
          totalRounds: (_gameMode == GameMode.progressive)
              ? 10
              : (_gameMode == GameMode.endless ? 100 : _rounds),
          jeopardyEnabled:
