...
class VectorPatternPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _drawTriangle(
      ...
      size,
      paint,
      tertiaryColor.withValues(alpha: opacity),
    ...
    _drawSymbol(
      ...
      size,
      '+',
      primaryColor.withValues(alpha: opacity * 2),
    ...
    _drawSymbol(
      ...
      size,
      '÷',
      secondaryColor.withValues(alpha: opacity * 2),
    ...
    _drawSymbol(
      ...
      size,
      '×',
      tertiaryColor.withValues(alpha: opacity * 2),
  ...
  void _drawTriangle(
    ...
    final path = Path();
    final center = Offset(
      size.width * relativePos.dx,
      size.height * relativePos.dy,
    );
  ...
  void _drawCircle(
    ...
    paint.color = color;
    canvas.drawCircle(
      Offset(size.width * relativePos.dx, size.height * relativePos.dy),
      radius,
      paint,
    );
  }
